...
// Vary K test for Cube, Dynamic Cube, Sphere and ImpGreedy
// Output format:
//    First line: N D number_of_tests (call it t)
...
const string output_filename = "Results/varyk.log";
const string output_deletion_filename = "Results/varyk-del.log";

// Usage: <executable> <data-type> <test insertion> <test deletion> <m>
